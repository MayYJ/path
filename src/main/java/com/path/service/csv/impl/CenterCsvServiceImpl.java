...
public class CenterCsvServiceImpl implements CsvService<CenterNode> {
    ...
    public boolean storeDatabase(List<CenterNode> list) {
        List<CenterNode> centerNodes = centerNodeMapper.selectAllCenterNodeAddress("1");
        if(centerNodes.size() > 0){
            return centerNodeMapper.updateAdvance(list);
        }
    ...
    public boolean deleteData() {
        return centerNodeMapper.deleteAllCenterNodes();
    }
